...
<head>
	...
	<title>Informatic Shop</title>

	<!-- Site Icon -->
	<link rel="shortcut Icon" type="..assets/image/png" href="../assets/img/favicon.png">
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto my-2 my-lg-0">
				<li class="nav-item">
					<a class="nav-link js-scroll-trigger" href="product.html">Home</a>
				</li>
	...
	<header class="page-section masthead2">
		<div class="container h-50">
			<h1 class="section-header text-white font-weight-bold"></h1>
			<p class="main-menu text-white-75 font-weight-light mb-5"><a class="link-menu" href="home.html">  <span style="color:white;"></span></a></p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 blog-form">
					...
					<p class="blog-sidebar-list"><b><span class="list-icon"> > </span> SSD </b></p>
					<p class="blog-sidebar-list"><b><span class="list-icon"> > </span> RAM </b></p>
					<p class="blog-sidebar-list"><b><span class="list-icon"> > </span> Mouse&Keyboard </b></p>
					<p class="blog-sidebar-list"><b><span class="list-icon"> > </span> Casing PC  </b></p>
					<p class="blog-sidebar-list"><b><span class="list-icon"> > </span> Printer </b></p>
				...
				<div class="col-lg-9" style="padding-left: 30px;">
					...
					<div class="row">
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item7.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item8.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item3.jpg" class="product-image">
					...
					<div class="row">
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="img/coffee_item7.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item4.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item5.jpg" class="product-image">
					...
					<div class="row">
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item1.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item2.jpg" class="product-image">
						...
						<div class="col-sm-3 col-md-6 col-lg-4">
							<div class="card">
								<div class="card-body text-center">
									<img src="../assets/img/coffee_item6.jpg" class="product-image">
	...
	<section class="page-section subscribe-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<img src="../assets/img/savannah_white.png" alt="img/savannah_white.png">
				...
				<div class="col-lg-4">
					...
					<p class="contact-info"><i class="fa fa-map-marker"></i>  EFAB Estate Avenue, FCT Abuja, Nigeria</p>
					<p class="contact-info"><i class="fa fa-phone"></i> +2349090420165</p>
					<p class="contact-info"><i class="fa fa-envelope"></i>  info@Informaticcafe.com</p>
					<p class="contact-info"><i class="fa fa-globe"></i> www.Informaticcafe.com</p>
				</div>
	...
	<footer class="footer-info pt-5 py-4">
		<div class="container">
			<div class="small text-center text-muted">
				<span class="footer-title">Savannah Cafe </span> <span class="copyright">&copy; All Right Reserved 2021</span>
			</div>
